...
3. Plan X content (singles, threads, articles)
4. Select YouTube topics (3/week from Riley's YouTube candidates)
...
Output Format:
Generate a structured content plan with:
- Daily slot assignments (Mon-Sun) with pillar, template, format, and topic
- Pillar distribution check (actual vs target)
- Interview prompts for Tony (10-15 total with pillar and rationale)
- X content picks (singles, threads, article topic)
- YouTube selections (3 topics with keyword alignment)
